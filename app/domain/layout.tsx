        ...
        <Card className="w-full h-full rounded-[1.5rem] flex flex-row">
          <div className="w-3/12 text-left rounded-xl p-4">
            ...
            <div className="flex flex-col gap-2 mt-5">
              ...
              <button className={"text-left hover:bg-[#333333] py-2 px-2.5 rounded-md flex " + (PathCheck("/domain/dns") && "bg-[#333333]")}>
                <MdDns className="my-auto mr-2 w-6 h-6 text-[#5a5a5a]" />
                DNS 設定 (開發中)
              </button>
              <button className={"text-center hover:bg-[#333333] py-2 px-2.5 rounded-md flex " + (PathCheck("/domain/ssl") && "bg-[#333333]")}>
                <MdLock className="my-auto mr-2 w-6 h-6 text-[#5a5a5a]" />
                網站憑證 (開發中)
              </button>
              <button className={"text-center hover:bg-[#333333] py-2 px-2.5 rounded-md flex " + (PathCheck("/domain/extension") && "bg-[#333333]")}>
                <IoExtensionPuzzle className="my-auto mr-2 w-6 h-6 text-[#5a5a5a]" />
                擴充元件 (開發中)
              </button>
              <hr className="my-1 border-[#5a5a5a]" />
              <button className={"text-center hover:bg-[#333333] py-2 px-2.5 rounded-md flex " + (PathCheck("/domain/server") && "bg-[#333333]")}>
